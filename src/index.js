...
.el-dropdown-menu__item:not(.is-disabled):hover {
    ...
    color: --primary-hover-border-color;
}
...
.el-radio-button:focus:not(.is-focus):not(:active):not(.is-disabled) {
    -webkit-box-shadow: 0 0 2px 2px --primary-color;
...
.el-tabs__item:focus.is-active.is-focus:not(:active) {
    -webkit-box-shadow: 0 0 2px 2px --primary-color inset;
...
.el-tag--dark .el-tag__close:hover {
    color: #fff;
    background-color: --primary-hover-border-color;
}
...
.el-tag--dark.el-tag--success .el-tag__close:hover {
    color: #fff;
    background-color: --success-hover-border-color;
}
...
.el-tag--dark.el-tag--warning .el-tag__close:hover {
    color: #fff;
    background-color: --warning-hover-border-color;
}
...
.el-tag--dark.el-tag--danger .el-tag__close:hover {
    color: #fff;
    background-color: --danger-hover-border-color;
}
.el-tag--plain {
    background-color: #fff;
    border-color: --primary-plain-border-color;
    color: --primary-color;
}
.el-tag--plain.is-hit {
    border-color: --primary-color;
...
.el-tag--plain.el-tag--success {
    background-color: #fff;
    border-color: --success-plain-border-color;
    color: --success-color;
}
...
.el-tag--plain.el-tag--warning {
    background-color: #fff;
    border-color: --warning-plain-border-color;
    color: --warning-color;
}
...
.el-tag--plain.el-tag--danger {
    background-color: #fff;
    border-color: --danger-plain-border-color;
    color: --danger-color;
}
...
.el-color-predefine__color-selector.selected {
    -webkit-box-shadow: 0 0 3px 2px --primary-color;
...
.el-link.el-link--danger:hover {
    color: --danger-hover-border-color;
}
...
.el-link.el-link--success:hover {
    color: --success-hover-border-color;
}
...
.el-link.el-link--warning:hover {
    color: --warning-hover-border-color;
}
...
.el-button--primary:hover {
    background: --primary-hover-border-color;
...
.el-button--primary.is-plain.is-disabled:hover {
    color: --primary-plain-disabled-color;
    background-color: --primary-hover-color;
    border-color: --primary-border-color;
}
.el-button--success {
...
.el-button--success:hover {
    background: --success-hover-border-color;
...
.el-button--success.is-plain.is-disabled:hover {
    color: --success-plain-disabled-color;
    background-color: --success-hover-color;
    border-color: --success-border-color;
}
.el-button--warning {
...
.el-button--warning:hover {
    background: --warning-hover-border-color;
...
.el-button--warning.is-plain.is-disabled:hover {
    color: --warning-plain-disabled-color;
    background-color: --warning-hover-color;
    border-color: --warning-border-color;
}
.el-button--danger {
...
.el-button--danger:hover {
    background: --danger-hover-border-color;
...
.el-button--danger.is-plain.is-disabled:hover {
    color: --danger-plain-disabled-color;
    background-color: --danger-hover-color;
    border-color: --danger-border-color;
}
.el-button--info {
...
.el-checkbox-button.is-checked .el-checkbox-button__inner {
    ...
    background-color: --primary-color;
    border-color: --primary-color;
    -webkit-box-shadow: -1px 0 0 0 --primary-plain-disabled-color;
    box-shadow: -1px 0 0 0 --primary-plain-disabled-color;
}
...
let transferTheme = obj => {
  ...
  let woff = require("element-ui/lib/theme-chalk/fonts/element-icons.woff");
  let ttf = require("element-ui/lib/theme-chalk/fonts/element-icons.ttf");
  ...
  /****************加载 primary start*************/
  let primaryColor = obj.primary || "#2196f3";
  ...
  /****************加载 info start*************/
  let infoColor = obj.info || "#dcdfe6";
  result = result.replaceAll("--info-color", infoColor);
  result = result.replaceAll(
    "--info-hover-color",
    Color(infoColor)
      .mix(Color("white"), 0.9)
  ...
  result = result.replaceAll(
    "--info-hover-border-color",
    Color(infoColor)
      .mix(Color("white"), 0.2)
      .hex()
  );
  result = result.replaceAll(
    "--info-plain-border-color",
    Color(infoColor)
      .mix(Color("white"), 0.6)
      .hex()
  );
